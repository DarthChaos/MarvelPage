...
import EndButtons from "./SubscriptionsSearchButtons";
  ...
  return (
    <>
      <Portal className='lg:hidden'>
        <div className='w-full min-[426px]:max-w-[375px] h-full bg-light-black'>
          <NavItems />
        </div>
      </Portal>
      <div className='bg-light-black fixed w-full text-white z-50'>
        <Container className='h-[52px] border-b border-solid border-dark-gray'>
